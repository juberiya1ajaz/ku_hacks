        ...
        <div>
            {file.name ? (
                ...
                <div className="grid place-items-center">
                    ...
                    <h1 className="py-5 text-5xl font-bold text-white">Gastrointestinal Stomach Tumor Prediction</h1>
                    ...
                    <div className="py-6">
                        ...
                        {isDragActive ? (
                            <div className='w-96 h-96 rounded-lg mb-24 bg-gray-100 grid place-items-center' data-testid="dropzone-container"  {...getRootProps()}>
                                <Image src="/assets/uploadImage.svg" width="100" height="100" className="w-28 h-28 pt-8" alt="Illustration upload" />
